...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  3 16:19:43 2021
...
def reverse_every_k_elements(head: Node, k: int) -> Node or None:
    """
    Time Complexity: O(N)
    ...
    -------
    Node or None
        The LinkedList reversed every 'k' sized sub-list starting from the head.
...
if __name__ == '__main__':
    ...
    print(a)
    print(reverse_every_k_elements(a, 3))
